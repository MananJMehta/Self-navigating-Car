...
//
//        if (next_lane == 8 && current_lane == 7)
//        {
//            next_lane = 0;
//            current_lane++;
//        }
//        else if (next_lane == 0 && current_lane == 8)
//        {
//            next_lane++;
//            current_lane = 0;
//        }
...
//    }
//
//    memcpy(lane_lut, local_lanes, sizeof(lane_lut));memcpy(lane_lut, local_lanes, sizeof(lane_lut));
//    return true;
//}

bool Lidar_Sensor::lane_algorithm()
{
